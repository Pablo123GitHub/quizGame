...
Clock.prototype.displayMilSecNiceFormat = function(timeMilSec) {
  return this.formatTime(this.extractHourFromMilSec(timeMilSec),
                          this.extractMinFromMilSec(timeMilSec),
                          this.extractSecFromMilSec(timeMilSec));
}
